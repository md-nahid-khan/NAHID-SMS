...
time.sleep(1)
os.system("clear")
os.system("xdg-open https://t.me/md_nahid_khan")
logo3=("""
...
╚═╝  ╚═══╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝╚═════╝  
\033[1;94m[+]===============================================================[+]
\033[1;94m[+]\033[1;32m               CREATED BY   :  Nahid Khan                 \033[1;94m[+]
\033[1;94m[+]\033[1;32m               ON GITHUB    :  Nahid khan                     \033[1;94m[+]
...
while amount>ses:
  ...
  if sent1.status_code==200:
    ses+=1
    print(f"\n{ses}  \033[38;5;46mNahid SMS WAS SENT🐼")
  else:
    pass
